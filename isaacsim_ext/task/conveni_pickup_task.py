...
from ..model import ConvenienceStore, RMPFlowTarget, UR5e
from ..model.factory import create_camera, create_light, create_viewport


class ConveniPickupTask(BaseTask):
    """
    コンビニの商品棚から商品を移動するタスク
